...
void Graph::Base(VI &U, VI &V, VI &C)
{
	...
	if ((!flag || doing.size() == 0) && V.size() >= K_V)
	{
		CheckMaximal(V);
	}
}

bool Graph::CheckRecurrence(VI &V)
{
	I count = 0;
